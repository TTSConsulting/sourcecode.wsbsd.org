...
class Program
{
    ...
    static void Main()
    {
        ...
        Thread.Sleep(1000);
        Console.WriteLine("Starting WSBSD DragonBSD 6.4.2 Kernel...");
        Thread.Sleep(1000);
        Console.WriteLine("All Kernels started Now Starting WSBSD DragonBSD 6.4.2");
        Thread.Sleep(1000);
        Console.WriteLine("DragonBSD Started Booting sh...");
        Thread.Sleep(1000);
        Console.Clear();
...
....#@@#-..          ..............-#@@@%=:::#@%####%@@=:-+%@@@+:.......  ............ ...:=%@@+....
     ...
     ............----#@@%=---:::::::::::::::::%@%###@@-::::::::::::::::::--=#@@@---.............    
                    ...
                    ..................-*%@@@@@@@%##%@@@@@@@@%*=.............                        
                                     ...
                                     .........=@%%%%@=..........                                    
                                      ..  ....=@@@%@@=..... ....                                    
                                          ...
                                          .....%@#%@-.                                              
                                          .....%@%@@-.                                              ";
        string systemInfo = $"\x1b[38;2;237;28;36m" + $@"
        {Environment.UserName}@{Environment.MachineName}
        ------------------------------------------------
        User: {Environment.UserName}
        Machine: {Environment.MachineName}
        OS: DragonFly BSD 6.4.2 On {Environment.OSVersion.VersionString} amd64 (x64 or 64 Bits)
        Kernel: FREEBSDKERNEL: DragonFly BSD 6.4.2 Kernel | BSDKENREL: 4.4BSDLite | UNIXKERNEL: Unix Kernel v7.0 | WSBSDKERNEL: WSBSD1.0.0.4
        Uptime: {GetUptime()}
        ...
        if (!Console.IsOutputRedirected)
        {
            ...
            {
                Console.WriteLine("\x1b[38;2;237;28;36m" + line + "\u001b[0m");

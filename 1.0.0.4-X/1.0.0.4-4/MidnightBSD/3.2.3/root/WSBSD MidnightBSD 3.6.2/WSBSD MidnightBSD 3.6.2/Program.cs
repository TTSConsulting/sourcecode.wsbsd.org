...
class Program
{
    ...
    static void Main()
    {
        ...
        Thread.Sleep(1000);
        Console.WriteLine("Starting WSBSD  MidnightBSD 3.2.3 Kernel...");
        Thread.Sleep(1000);
        Console.WriteLine("All Kernels started Now Starting WSBSD MidnightBSD 3.2.3");
        Thread.Sleep(1000);
        Console.WriteLine("MidnightBSD Started Booting sh...");
        Thread.Sleep(1000);
        Console.Clear();
     ...
     .=@@@@+.    .-%@@@@@@@@@@@@@@@@@@@@@%=..  =@=.  *@@@@@@@@@@@@@@@@@@%=              :#@@@%:.    
      .+@@@@+.    .-%@@@@@@@@@@@@@@@@@@@@@@@+:..#@=. +@@@@@@@@@@@@@@@@@@%-            .:#@@@%-.     
       ...
       ..*@@@@*.    ..=%@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@+:#@%=  .:-:.    -%@@@@-.       
        ...
        Kernel: MIDNIGHTBSDKERNEL: MidnightBSD 3.2.3 Kernel | BSDKENREL: 4.4BSDLite | UNIXKERNEL: Unix Kernel v7.0 | WSBSDKERNEL: WSBSD1.0.0.4
        Uptime: {GetUptime()}
